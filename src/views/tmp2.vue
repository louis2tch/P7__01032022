       ...
       <div id="chat">
         <div v-for="i in existedAllChat()" :key="i.id" class="chatAll">
           ...
           <div class="chatComment">{{ i.comment }}
             <div>
               <i v-if="i.like == 1" class="fa fa-thumbs-up" @click="like(i.id, i.id_user)" :id="i.id+'like'" :title="i.id+'like'"></i>
            ...
            //////////////////////
            <div class="chatComment" ><span v-html="i.comment"></span>
             <div v-if="i.like == 1">
               <i v-if="i.like == 1" class="fa fa-thumbs-up green" @click="like(i.id, i.id_user, i.like)" :id="i.id+'like'" :title="i.id+'like'"></i>
               <i v-else class="fa fa-thumbs-up" @click="like(i.id, i.id_user, i.like)" :id="i.id+'like'" :title="i.id+'like'"></i>
               <span :id="i.id+'likeResult'" >{{ i.likes }}</span>&nbsp;&nbsp;
               <i v-if="i.dislike == 1" class="fa fa-thumbs-down green" @click="dislike(i.id, i.id_user, i.dislike)"  :id="i.id+'dislike'"  :title="i.id+'dislike'"></i>
               <i v-else class="fa fa-thumbs-down" @click="dislike(i.id, i.id_user, i.dislike)"  :id="i.id+'dislike'"  :title="i.id+'dislike'"></i>
